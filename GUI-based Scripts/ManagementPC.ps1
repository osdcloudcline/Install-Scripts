$MPCprocesses = @(
  ...
  Script = "https://github.com/osdcloudcline/Install-Scripts/raw/main/Individual%20Scripts/GUI-based/Management%20PC/Browsers.ps1"
  },
  @{
  Name = "Processing: File Transfer Software" 
  Script = "https://github.com/osdcloudcline/Install-Scripts/raw/main/Individual%20Scripts/GUI-based/Management%20PC/FileTransfer.ps1"
  },
  @{
  Name = "Processing: Security Software"
  Script = "https://github.com/osdcloudcline/Install-Scripts/raw/main/Individual%20Scripts/GUI-based/Management%20PC/Security.ps1"
  },
  @{
  Name = "Processing: Programming Software"
  Script = "https://github.com/osdcloudcline/Install-Scripts/raw/main/Individual%20Scripts/GUI-based/Management%20PC/Programming.ps1"
  },
  @{
  ...
  Start-SplashScreen -Processes $MPCprocesses -MessageHeader "Management PC Client Installation - Configuring $env:computername"
