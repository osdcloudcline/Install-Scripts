...
do 
{
  ...
  '1'{  cls
        ...
        Rename-Item -Path "C:\Provisioning Packages\Advanced Software Configuration\PPKG Files\Software\Install%20Client%20OS%20SYSTEM%20PowerShell%207.x%20Modules.ppkg" -NewName "C:\Provisioning Packages\Advanced Software Configuration\PPKG Files\Software\Install Client OS SYSTEM PowerShell 7 Modules.ppkg" -Force
