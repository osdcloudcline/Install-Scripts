$UtilitiesHardwareInstallLog = "C:\Logs\Installs\Software\IT\GUI\$env:computername-HardwareUtilities.log"
...
$UtilitiesSoftwareInstallLog = "C:\Logs\Installs\Software\IT\GUI\$env:computername-SoftwareUtilities.log"
