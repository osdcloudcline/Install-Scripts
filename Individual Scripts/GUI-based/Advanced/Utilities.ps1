...
Save-WebFile -SourceUrl $GlaryZipURL -DestinationDirectory $OSDCloudGHdownloads
Expand-7Zip -ArchiveFileName "$OSDCloudGHdownloads\GlaryUtilities.zip" -TargetPath $GlaryUnZipPath 
