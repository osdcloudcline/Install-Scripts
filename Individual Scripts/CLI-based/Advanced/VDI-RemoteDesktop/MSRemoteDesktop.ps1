...
Expand-7Zip -ArchiveFileName "$RDPDestination\RemoteDesktop.zip.001" -TargetPath $RDPDestination  
Expand-7Zip -ArchiveFileName "$RDPDestination\RemoteDesktop.zip.002" -TargetPath $RDPDestination  
