Start-Transcript -Path "C:\Logs\Powershell\Install\Management PC\Cloud Backups\$env:computername-UPBR.log"
...
Write-Host "Acquiring and Downloading $app1 from OSDCloudCline GitHub Repo..." -ForegroundColor Green
