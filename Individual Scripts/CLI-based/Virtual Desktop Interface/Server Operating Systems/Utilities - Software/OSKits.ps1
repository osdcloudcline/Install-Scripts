Start-Transcript -Path "C:\Logs\OSDCloud\Install\Server VDI\Utilities-Software\$env:computername-OSADKSDKPE.log"
...
Start-Process -FilePath "C:\OSDCloud\GitHub\downloads\adksetup.exe" -ArgumentList "/quiet /norestart"
...
Start-Process -FilePath "C:\OSDCloud\GitHub\downloads\adkwinpesetup.exe" -ArgumentList "/quiet /norestart"
