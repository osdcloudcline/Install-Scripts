Start-Transcript -Path "C:\Logs\OSDCloud\Install\Standard\Virtualization\$env:computername-VMWareWSPro.log"

$Date = Get-Date

Write-Host "Installed on: $Date"

$app1 = "VMWare Workstation Professional 17.6.2 Build 24409292"
