...
Write-Host "Processing download for: Manufacturer Software..." -ForegroundColor DarkBlue -BackgroundColor White

$Dell = Invke-WebRequest("https://github.com/osdcloudcline/Install-Scripts/raw/refs/heads/main/Individual%20Scripts/CLI-based/Manufacturer-Specific%20Scripts/Dell/Dell.ps1")
